...
class SandboxApi:
    ...
    def list_sandboxes(
        ...
        sandbox_class: Annotated[Optional[List[SandboxClass]], Field(description="List of sandbox classes to filter by")] = None,
        ...
        :param sandbox_class: List of sandbox classes to filter by
        :type sandbox_class: List[SandboxClass]
    ...
    def _list_sandboxes_serialize(
        ...
        if sandbox_class is not None:
            ...
            _query_params.append(('sandboxClass', sandbox_class))
