...
module DaytonaApiClient
  class SandboxApi
    ...
    # @option opts [Array<SandboxClass>] :sandbox_class List of sandbox classes to filter by
    ...
    def list_sandboxes_with_http_info(opts = {})
      ...
      query_params[:'sandboxClass'] = @api_client.build_collection_param(opts[:'sandbox_class'], :multi) if !opts[:'sandbox_class'].nil?
